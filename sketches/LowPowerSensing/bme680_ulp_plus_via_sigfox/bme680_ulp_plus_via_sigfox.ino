...
/*-----------------*/
  ...
  // Print the header
//  output = "Timestamp [ms], raw temperature [°ÎC], pressure [hPa], raw relative humidity [%], gas [Ohm], IAQ, IAQ accuracy, temperature [°ÎC], relative humidity [%]";
  output = "Timestamp [ms], pressure [hPa], IAQ, IAQ accuracy, temperature [°ÎC], relative humidity [%]";
  Serial.println(output);
}
