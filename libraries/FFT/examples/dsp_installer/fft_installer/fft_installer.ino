/*
 *  fft_installer.ino - FFT dsp installer
 ...
 *  A range of Audio DSP functions are available. This skecth loads FFT.
 *
 *  Run the sketch and you should see
 *    Select where to install FFT?
 ...
 *  If '1' is input,
 *    Install: /mnt/sd0/BIN/DSPFFT Done.
 *  If '2' is input,
 *    Install: /mnt/spif/BIN/DSPFFT Done.
 *    Finished.
 *
...
void setup()
{
  ...
  // Display Menu
  Serial.println("Select where to install DSPFFT?");
