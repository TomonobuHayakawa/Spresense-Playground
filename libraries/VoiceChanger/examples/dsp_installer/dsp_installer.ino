/*
 *  dsp_installer.ino - Voice changer dsp installer
 ...
 *  A range of Audio DSP functions are available. This skecth loads VOICHG.
 *
 *  Run the sketch and you should see
 *    Select where to install VOICHG?
 ...
 *  If '1' is input,
 *    Install: /mnt/sd0/BIN/VOICHG Done.
 *  If '2' is input,
 *    Install: /mnt/spif/BIN/VOICHG Done.
 *    Finished.
 *
...
void setup()
{
  ...
  // Display Menu
  Serial.println("Select where to install VOICHG?");
